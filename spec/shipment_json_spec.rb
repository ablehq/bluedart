...
describe "Generate shipment in json communication mode" do
  it 'should generate label using rest communication' do
    ...
    #     sender: "Old School Inspirations Pvt Ltd.",
    #     vendor_code: "099960",
    #     customer_name: "Old School Inspirations Pvt Ltd.",
    #     address: "ALEAP Green Industrial Park, Plot No-26  Block-A  Nandigama, Village  Patancheru (M.D)",
    #     customer_pincode: "502300",
    #     customer_mobile: "919915402666",
    #     customer_email_id: "care@oldschoolrituals.in",
    #     isToPayCustomer: false,
    #     origin_area: "HYD"
    #   },
    #   consignee_details: {
    #     consignee_name: "Madhusudhan",
    #     address: "Madhusudhan  P 234  St 7N, Kapra  Hyderadbad  Telangana, IN  500062", 
    #     consignee_pincode: "500062", 
    #     consignee_mobile:"919966372726",
    #     consignee_attention:"Madhusudhan"
    #   },
    #   services: {
    #     piece_count: 1,
    #     actual_weight: 0.5,
    ...
    #     special_instruction: "",
    #     declared_value: 950,
    #     credit_reference_no: "A5456221071-1-1147",
    #     dimensions: [
    #       {
    #         count: 1,
    #         height: 5,
    ...
    #       }
    #     ],
    #     pickup_date: "2023-06-21",
    #     pickup_time: "1530",
    #     commodities: ["rice-banana-face-cleanserx1"],
    #     product_type: "Dutiables",
    #     collactable_amount: 0,
    #     product_code: "A",
    #     sub_product_code: "P",
    ...
    #   debug: true,
    #   creds: {
    #     license_key: "sguz0fkmhnsvvtliuooorpsnrpfmkfhi",
    #     login_id: "MAA00001"
    #   }
    # }
    response_body = {
